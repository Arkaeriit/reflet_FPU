...
/* Compile hash: 3CCJC6bYk3kSZjpzZppakFCTatWN */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
NELUA_STATIC_ASSERT(sizeof(assembler_pure_file_block) == 56 && NELUA_ALIGNOF(assembler_pure_file_block) == 8, "Nelua and C disagree on type size or align");
...
NELUA_STATIC_ASSERT(sizeof(assembler_block_union) == 56 && NELUA_ALIGNOF(assembler_block_union) == 8, "Nelua and C disagree on type size or align");
struct assembler_block {
  assembler_block_types type;
  assembler_block_union content;
};
NELUA_STATIC_ASSERT(sizeof(assembler_block) == 64 && NELUA_ALIGNOF(assembler_block) == 8, "Nelua and C disagree on type size or align");
...
void nelua_memory_spancopy_7(nelua_span_block_ dest, nelua_span_block_ src) {
  ...
  if(NELUA_LIKELY((src.size > 0))) {
    memcpy((void*)dest.data, (void*)src.data, (size_t)(src.size * 64));
  }
}
...
nelua_span_block_ nelua_GCAllocator_spanalloc_6(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(NELUA_LIKELY((size > 0))) {
    assembler_block_arr0_ptr data = ((assembler_block_arr0_ptr)nelua_GCAllocator_alloc_2(self, (size * 64), flags_6, finalizer_6, userdata_6));
...
nelua_span_block_ nelua_GCAllocator_spanrealloc_6(nelua_GCAllocator_ptr self, nelua_span_block_ s, uintptr_t size) {
  ...
  assembler_block_arr0_ptr p = ((assembler_block_arr0_ptr)nelua_GCAllocator_realloc(self, (void*)s.data, (size * 64), s.size));
    ...
    if(((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))).type == 1)) {
      ...
      for(intptr_t j = 0, _end = parser_pure_file___len((&file)); j < _end; j = j + 1) {
        ...
        if(nelua_nlstring___eq(parser_pure_line___index((&line), 0), ((nlstring){(uint8_t*)"@define", 7}))) {
          ...
          assembler_pure_file_block macro_block = (assembler_pure_file_block){macro_2, parser_pure_line___index((&line), 0), 1, true};
...
nlmulret_nelua_vector_uint8__assembler_error_t assembler_assemble(nlstring input_file, nlstring runtime_start, nlstring runtime_end, int64_t addr_size) {
  ...
  assembler_pure_file_block run_start_block = (assembler_pure_file_block){parser_purify_string(runtime_start), {(uint8_t*)"runtime_start", 13}, 1, true};
  assembler_pure_file_block run_end_block = (assembler_pure_file_block){parser_purify_string(runtime_end), {(uint8_t*)"runtime_end", 11}, 1, true};
