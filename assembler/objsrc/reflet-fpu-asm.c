...
/* Compile hash: 7syKEoanc7ZQ1jZrtcg8jZ7gLpw */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
typedef nlmulret_nelua_vector_block__assembler_error_t (*function_3NrdPhio5FPQx44Bo)(nelua_vector_block_);
static nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_3NrdPhio5FPQx44Bo step);
    ...
    if(((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))).type == 1)) {
      ...
      for(intptr_t j = 0, _end = parser_pure_file___len((&file)); j < _end; j = j + 1) {
        ...
        if(nelua_nlstring___eq(parser_pure_line___index((&line), 0), ((nlstring){(uint8_t*)"@define", 7}))) {
          ...
          nlmulret_parser_pure_file_nlint64 _asgnret_1 = macro_expend_macro(line);
          parser_pure_file macro_2 = _asgnret_1.r1;
    ...
    if(((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))).type == 1)) {
      ...
      if((parser_pure_file___len((&file)) == 0)) {
        ...
        for(intptr_t j = 0, _end = parser_pure_file___len((&file)); j < _end; j = j + 1) {
          ...
          nlmulret_nluint16_nlint64_nlstring _asgnret_1 = assemble_line_assemble_line(line);
          uint16_t mc = _asgnret_1.r1;
          int64_t err = _asgnret_1.r2;
...
nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_3NrdPhio5FPQx44Bo step) {
  nlmulret_nelua_vector_block__assembler_error_t _asgnret_1 = step(in_block);
  nelua_vector_block_ ret = _asgnret_1.r1;
  assembler_error_t err = _asgnret_1.r2;
  while((err == -1)) {
    nlmulret_nelua_vector_block__assembler_error_t _asgnret_2 = step(ret);
    ret = _asgnret_2.r1;
    err = _asgnret_2.r2;
  }
  return (nlmulret_nelua_vector_block__assembler_error_t){ret, err};
...
nlmulret_nelua_vector_uint8__assembler_error_t assembler_assemble(nlstring input_file, nlstring runtime_start, nlstring runtime_end, int64_t addr_size) {
  ...
  nlmulret_nelua_vector_block__assembler_error_t _asgnret_2 = assembler_run_step(initial_vector, assembler_first_step);
  ...
  nlmulret_nelua_vector_block__assembler_error_t _asgnret_3 = assembler_run_step(step1_vector, assembler_second_step);
  ...
  nlmulret_nelua_vector_block__assembler_error_t _asgnret_4 = assembler_run_step(step2_vector, assembler_third_step);
